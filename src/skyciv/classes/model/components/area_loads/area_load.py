...
class AreaLoad:
    def __init__(self,
        ...
        Args:
            ...
            elevations (str, optional): Relevant only if "type": "column_wind_load". The elevations between which the corresponding pressure magnitudes(see next row in this table) should be applied.self property should have 1 more value than the corresponding pressure magnitudes property. Defaults to None.
            mags (str, optional): Relevant only if "type": "column_wind_load". The magnitudes of pressures which should be applied between the corresponding elevations(see above row in this table).self property should have 1 less value than the corresponding elevations property. Defaults to None.
