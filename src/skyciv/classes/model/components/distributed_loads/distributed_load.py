...
class DistributedLoad:
    ...
    def __init__(
        ...
        Args:
            ...
            x_mag_A (int, optional): Magnitude of load in x direction at the starting position A. Defaults to 0.
            y_mag_A (int, optional): Magnitude of load in y direction at the starting position A. Defaults to 0.
            z_mag_A (int, optional): Magnitude of load in z direction at the starting position A. Defaults to 0.
            x_mag_B (int, optional): Magnitude of load in x direction at the finish position B. Defaults to 0.
            y_mag_B (int, optional): Magnitude of load in y direction at the finish position B. Defaults to 0.
            z_mag_B (int, optional): Magnitude of load in z direction at the finish position B. Defaults to 0.
